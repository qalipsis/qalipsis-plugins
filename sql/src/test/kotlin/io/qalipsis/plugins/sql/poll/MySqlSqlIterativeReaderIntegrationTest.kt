 ...
 * @author Eric Jessé
 */
internal class MySqlSqlIterativeReaderIntegrationTest : AbstractSqlIterativeReaderIntegrationTest(
        "mysql", DialectConfigurations.MYSQL, {
    DialectConfigurations.MYSQL.createConnectionPool(SqlConnection(
        host = "localhost",
