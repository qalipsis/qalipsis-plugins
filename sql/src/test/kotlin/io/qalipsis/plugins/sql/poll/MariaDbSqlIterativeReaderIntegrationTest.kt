 ...
 * @author Eric Jessé
 */
internal class MariaDbSqlIterativeReaderIntegrationTest : AbstractSqlIterativeReaderIntegrationTest(
        "mysql", DialectConfigurations.MARIADB, {
    DialectConfigurations.MARIADB.createConnectionPool(SqlConnection(
        host = "localhost",
