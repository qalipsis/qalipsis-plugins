...
dependencies {
    ...
    constraints {
        ...
        // Plugins.
        api("io.qalipsis.plugin:qalipsis-plugin-cassandra:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-elasticsearch:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-graphite:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-influxdb:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-jackson:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-jakarta-ee-messaging:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-jms:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-kafka:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-mail:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-mongodb:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-netty:0.16.2-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-r2dbc-jasync:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-rabbitmq:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-redis-lettuce:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-slack:0.16.1-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-sql:0.16.0-SNAPSHOT")
        api("io.qalipsis.plugin:qalipsis-plugin-timescaledb:0.16.1-SNAPSHOT")
    }
}
