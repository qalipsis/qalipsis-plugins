...
@Testcontainers
internal class GraphiteMeasurementPublisherPickleIntegrationTest : AbstractGraphiteMeasurementPublisherProtocolTest() {
    ...
    companion object {
        ...
        private val CONTAINER = GenericContainer<Nothing>(
            ...
            withExposedPorts(Constants.HTTP_PORT, Constants.GRAPHITE_PICKLE_PORT)
